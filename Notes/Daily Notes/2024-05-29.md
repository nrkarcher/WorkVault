...
D-11273 - Dropping [[Licensing|licenses]] overnight
...
- Unclear expectations for [[Licensing|licensing]]. 
D-11147 - 10Duke - When all licenses of your default license are in use you will get a license error.
- We put a lot of tools into SeisWare instead of directing people or org/sys admin - put the work on the users IT team to do the work for their [[Licensing|licensing]].
- We should use different [[Licensing|licensing]] setups on the development/testing side. We should have at least one person in QA using a minimum number of licenses.  
...
- Get more people internally using new [[Licensing|licensing]] sooner.