...
- Yes, anything that hasn't already been started. Any new stuff should be started on [[11.0 Upgrade|11.0]].

Who wants to merge dev to [[11.0 Upgrade|11.0]]?
- Garby
- Who's responsibility is it to merge in general?

Is [[SDK Testing|SDKClient]].test related stuff blocking [[11.0 Upgrade|11.0]]
...
Scrum Lords:
- Mo - Bug Busters
- George - [[Gun Barrel|Gunny Bears]]
- Sam (remaining) - Filterdelphia

Action item: Book meeting to chat about how the device [[Licensing|licensing]] feature project came about and if we're cool with how things played out. Involve mgmt. - Milos
...
Merge dev to [[11.0 Upgrade|11.0]] - Garby
Book meeting to chat about how the device [[Licensing|licensing]] feature project came about and if we're cool with how things played out. Involve mgmt. - Milos